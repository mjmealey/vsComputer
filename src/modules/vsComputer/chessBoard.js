...
const chessBoard = () => {
    ...
    const chessGame = () => {
        ...
        const displayGameStateText = {
            ...
            ifBishopIsClickedAtStart: "You cannot move bishops at the start of the game",
            ifQueenIsClickedAtStart: "You cannot move the queen at the start of the game",
        ...
        chessPiecePositions.forEach(([mappedCellIds, chessMovePlaceHolder]) => (mappedCellIds.textContent = chessMovePlaceHolder));
        //start of game
        const displayGameState = document.createElement(displayGameStateText.textElement);
        if (
        ...
        gridContainer.addEventListener("click", (e) => {
            ...
            switch (clickedCell.id) {
                ...
                case gridCellIds[57]:
                case gridCellIds[63]:
                    if (mappedCellIds[[0, 7, 57, 63]].textContent ===
                ...
                case gridCellIds[48]:
                case gridCellIds[55]:
                    if (mappedCellIds[(8, 15, 48, 55)].textContent ===
                ...
                case gridCellIds[40]:
                case gridCellIds[47]:
                    if (mappedCellIds[[16, 23, 40, 47]].textContent ===
                ...
                case gridCellIds[24]:
                case gridCellIds[31]:
                    if (mappedCellIds[[24, 31]].textContent ===
                ...
                case gridCellIds[32]:
                case gridCellIds[39]:
                    if (mappedCellIds[[32, 39]].textContent === chessMovePlaceHolder.king &&
                        controlGameState === trackGameState.invalidFirstMove) {
                        displayGameState.innerText =
                ...
                case gridCellIds[57]:
                case gridCellIds[62]:
                    if (mappedCellIds[[1, 6, 9, 14, 17, 22, 25, 30, 33, 38, 41, 46, 49, 54, 57, 62]].textContent === chessMovePlaceHolder.pawn &&
                        controlGameState === trackGameState.invalidFirstMove) {
