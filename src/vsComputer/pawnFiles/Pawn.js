...
const Pawn = () => {
  ...
  newPlayerDoubleSpace.firstDoubleSpaceClicks();
  newPlayerDoubleSpace.secondDoubleSpaceClicks();
  newPlayerDoubleSpace.thirdDoubleSpaceClicks();
  newPlayerDoubleSpace.fourthDoubleSpaceClicks();
  newPlayerDoubleSpace.fifthDoubleSpaceClicks();
  newPlayerDoubleSpace.sixthDoubleSpaceClicks();
  newPlayerDoubleSpace.seventhDoubleSpaceClicks();
  newPlayerDoubleSpace.eighthDoubleSpaceClicks();
